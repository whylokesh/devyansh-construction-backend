...
func (h *SiteHandler) CreateSite(w http.ResponseWriter, r *http.Request) {
	...
	utils.RespondWithJSON(w, http.StatusCreated, "Site created successfully", site)
}
...
func (h *SiteHandler) GetSiteByID(w http.ResponseWriter, r *http.Request) {
	...
	utils.RespondWithJSON(w, http.StatusOK, "Site retrieved successfully", site)
}
...
func (h *SiteHandler) UpdateSite(w http.ResponseWriter, r *http.Request) {
	...
	utils.RespondWithJSON(w, http.StatusOK, "Site updated successfully", site)
}
...
func (h *SiteHandler) DeleteSite(w http.ResponseWriter, r *http.Request) {
	...
	utils.RespondWithJSON(w, http.StatusOK, "Site deleted successfully", nil)
}
...
func (h *SiteHandler) ListSites(w http.ResponseWriter, r *http.Request) {
	...
	utils.RespondWithJSON(w, http.StatusOK, "Sites retrieved successfully", sites)
}
